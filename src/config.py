...
from .constants import CIL_PATH, MASSACHUSETTS_PATH, DEEPGLOBE_PATH
...
_C.DATASET.TRAIN_DS = 'cil'
_C.DATASET.VAL_DS = 'cil'
_C.DATASET.TEST_DS = 'cil'
_C.DATASET.PATCH_SIZE = 224
_C.DATASET.CUT_SIZE = None # Cuts the image to this size (no resizing)
_C.DATASET.PATCH_STRIDE = _C.DATASET.PATCH_SIZE // 2
_C.DATASET.MIN_MASK_PERCENTAGE = 0.01
_C.DATASET.USE_AUG = True
...
_C.DATASET.CIL = CN()
_C.DATASET.CIL.PATH = CIL_PATH
_C.DATASET.CIL.SPLIT_TEST_VAL_RATIO = (0.9, 0.1)
...
_C.TRAINING.CALC_METRICS = False
